0// O JQuery ready function garante que todo o DOM foi carregado antes de executar o script
...
const translations = {
  ...
  footer_direitos: "© FAPESPA - Fundação Amazônia de Amparo a Estudos e Pesquisas",
    ...
    // MAPA INTERATIVO
    mapa_carregando: "Carregando dados...",
    mapa_titulo_eyebrow: "Mapa Interativo",
    mapa_titulo: "Mapa Interativo do Pará",
    mapa_subtitulo: "Explore dados territoriais, demográficos, econômicos, sociais e ambientais dos 144 municípios paraenses.",
    mapa_controles: "Controles de Visualização",
    mapa_ano: "Ano",
    mapa_todos_anos: "Todos os anos",
    mapa_categoria: "Categoria",
    mapa_selecione_categoria: "Selecione uma categoria",
    mapa_indicador: "Indicador",
    mapa_selecione_categoria_primeiro: "Selecione uma categoria primeiro",
    mapa_informacoes: "Informações",
    mapa_info_texto: "Passe o mouse sobre uma região para visualizar as informações.",
    mapa_legenda: "Legenda",
    mapa_legenda_texto: "Selecione um indicador para visualizar a legenda",
    mapa_modal_titulo: "Mapa",
    mapa_btn_abrir: "Abrir em Nova Aba",
    mapa_btn_baixar: "Baixar",
    mapa_abrir_nova_aba: "Abrir imagem em nova aba",
    mapa_baixar_imagem: "Baixar imagem",
    btn_voltar_topo: "Voltar ao topo",
    btn_fechar: "Fechar",
    footer_sobre_titulo: "Sobre FAPESPA",
    footer_sobre_texto: "Fundação Amazônia de Amparo a Estudos e Pesquisas, promovendo ciência, tecnologia e inovação para o desenvolvimento do estado.",
    footer_produtos_titulo: "Produtos",
    footer_localizacao_titulo: "Localização",
    footer_iframe_title: "Localização FAPESPA",
    footer_copyright: "© Anuário Estatístico do Pará. Todos os direitos reservados.",
    modal_conteudo: "Conteúdo",
    modal_abrir_nova_aba: "Abrir em nova aba",
    // MAPA AVANÇADO
    mapa_buscar_placeholder: "Buscar município...",
    mapa_limpar_busca: "Limpar busca",
    mapa_3d_toggle: "Visualização 3D",
    mapa_exportar_dados: "Exportar Dados",
    mapa_tela_cheia: "Tela Cheia",
    mapa_filtros_avancados: "Filtros Avançados",
    mapa_valor_faixa: "Faixa de Valores:",
    mapa_valor_minimo: "Valor Mínimo",
    mapa_valor_maximo: "Valor Máximo",
    mapa_regiao: "Região de Integração",
    mapa_selecione_regiao: "Selecione uma região",
    mapa_aplicar_filtros: "Aplicar Filtros",
    mapa_limpar_filtros: "Limpar Filtros",
    mapa_tab_info: "Informações",
    mapa_tab_comparar: "Comparar",
    mapa_tab_historico: "Histórico",
    mapa_tab_estatisticas: "Estatísticas",
    mapa_municipio_nome: "Município",
    mapa_municipio_regiao: "Região",
    mapa_municipio_valor: "Valor",
    mapa_comparacao_vazia: "Nenhum município selecionado",
    mapa_comparacao_instrucao: "Clique em um município no mapa para adicionar à comparação (máximo 5).",
    mapa_historico_vazio: "Selecione um município",
    mapa_estatisticas_media: "Média Estadual",
    mapa_estatisticas_maior: "Maior Valor",
    mapa_estatisticas_menor: "Menor Valor",
    mapa_estatisticas_desvio: "Desvio Padrão",
  ...
  en: {
    ...
    tema_economia_texto: "The economic theme covers six major sub-themes: Agriculture (permanent and temporary crops), Livestock, Forest Extraction, GDP, Trade Balance, and Public Finance.",
    tema_infraestrutura_titulo: "Infrastructure",
    tema_infraestrutura_texto: "The infrastructure theme includes information on vehicle fleet, energy consumers and consumption, water supply, and other services.",
    tema_meio_ambiente_titulo: "Environment",
    tema_meio_ambiente_texto: "The environmental theme provides information on deforestation, forest area, hydrography, heat sources, protected areas, and conservation units.",
    tema_social_titulo: "Social",
    tema_social_texto: "The social theme addresses information and indicators of six major sub-themes: Education, Social Inclusion, Labor Market, Social Security, Health, and Public Safety.",
    tema_mapas_titulo: "Maps",
    tema_mapas_texto: "The Pará Statistical Yearbook provides its users with a set of thematic maps featuring the main social, economic, and environmental indicators of the state.",
    ...
    footer_horario: "Mon-Fri: 8am to 2pm",
    footer_direitos: "© FAPESPA - Amazon Foundation for Support of Studies and Research. All rights reserved.",
    ...
    // MAPA INTERATIVO
    mapa_carregando: "Loading data...",
    mapa_titulo_eyebrow: "Interactive Map",
    mapa_titulo: "Interactive Map of Pará",
    mapa_subtitulo: "Explore territorial, demographic, economic, social, and environmental data from 144 municipalities in Pará.",
    mapa_controles: "Visualization Controls",
    mapa_ano: "Year",
    mapa_todos_anos: "All years",
    mapa_categoria: "Category",
    mapa_selecione_categoria: "Select a category",
    mapa_indicador: "Indicator",
    mapa_selecione_categoria_primeiro: "Select a category first",
    mapa_informacoes: "Information",
    mapa_info_texto: "Hover over a region to view information.",
    mapa_legenda: "Legend",
    mapa_legenda_texto: "Select an indicator to view the legend",
    mapa_modal_titulo: "Map",
    mapa_btn_abrir: "Open in New Tab",
    mapa_btn_baixar: "Download",
    mapa_abrir_nova_aba: "Open image in new tab",
    mapa_baixar_imagem: "Download image",
    btn_voltar_topo: "Back to top",
    btn_fechar: "Close",
    footer_sobre_titulo: "About FAPESPA",
    footer_sobre_texto: "Amazon Foundation for Support of Studies and Research, promoting science, technology, and innovation for the state's development.",
    footer_produtos_titulo: "Products",
    footer_localizacao_titulo: "Location",
    footer_iframe_title: "FAPESPA Location",
    footer_copyright: "© Pará Statistical Yearbook. All rights reserved.",
    modal_conteudo: "Content",
    modal_abrir_nova_aba: "Open in new tab",
    // ADVANCED MAP
    mapa_buscar_placeholder: "Search municipality...",
    mapa_limpar_busca: "Clear search",
    mapa_3d_toggle: "3D View",
    mapa_exportar_dados: "Export Data",
    mapa_tela_cheia: "Full Screen",
    mapa_filtros_avancados: "Advanced Filters",
    mapa_valor_faixa: "Value Range:",
    mapa_valor_minimo: "Minimum Value",
    mapa_valor_maximo: "Maximum Value",
    mapa_regiao: "Integration Region",
    mapa_selecione_regiao: "Select a region",
    mapa_aplicar_filtros: "Apply Filters",
    mapa_limpar_filtros: "Clear Filters",
    mapa_tab_info: "Information",
    mapa_tab_comparar: "Compare",
    mapa_tab_historico: "History",
    mapa_tab_estatisticas: "Statistics",
    mapa_municipio_nome: "Municipality",
    mapa_municipio_regiao: "Region",
    mapa_municipio_valor: "Value",
    mapa_comparacao_vazia: "No municipality selected",
    mapa_comparacao_instrucao: "Click on a municipality on the map to add to comparison (maximum 5).",
    mapa_historico_vazio: "Select a municipality",
    mapa_estatisticas_media: "State Average",
    mapa_estatisticas_maior: "Maximum Value",
    mapa_estatisticas_menor: "Minimum Value",
    mapa_estatisticas_desvio: "Standard Deviation",
  ...
  es: {
    ...
    tema_economia_texto: "La temática económica abarca seis grandes subtemas: Agricultura (cultivos permanentes y temporales), Ganadería, Extracción Forestal, PIB, Balanza Comercial y Finanzas Públicas.",
    tema_infraestrutura_titulo: "Infraestructura",
    tema_infraestrutura_texto: "La temática de infraestructura incluye información sobre flota de vehículos, consumidores y consumo de energía eléctrica, abastecimiento de agua y otros servicios.",
    ...
    tema_social_titulo: "Social",
    tema_social_texto: "La temática social aborda información e indicadores de seis grandes subtemas: Educación, Inclusión Social, Mercado Laboral, Seguridad Social, Salud y Seguridad Pública.",
    tema_mapas_titulo: "Mapas",
    ...
    footer_endereco: "Av. Presidente Vargas, 670, Belém - PA",
    footer_telefone: "+55 (91) 3323-2550",
    footer_horario: "Lun-Vie: 8h a 14h",
    footer_direitos: "© FAPESPA - Fundación Amazonia de Apoyo a Estudios e Investigaciones. Todos los derechos reservados.",
    ...
    // MAPA INTERATIVO
    mapa_carregando: "Cargando datos...",
    mapa_titulo_eyebrow: "Mapa Interactivo",
    mapa_titulo: "Mapa Interactivo de Pará",
    mapa_subtitulo: "Explore datos territoriales, demográficos, económicos, sociales y ambientales de los 144 municipios de Pará.",
    mapa_controles: "Controles de Visualización",
    mapa_ano: "Año",
    mapa_todos_anos: "Todos los años",
    mapa_categoria: "Categoría",
    mapa_selecione_categoria: "Seleccione una categoría",
    mapa_indicador: "Indicador",
    mapa_selecione_categoria_primeiro: "Seleccione una categoría primero",
    mapa_informacoes: "Información",
    mapa_info_texto: "Pase el cursor sobre una región para ver la información.",
    mapa_legenda: "Leyenda",
    mapa_legenda_texto: "Seleccione un indicador para visualizar la leyenda",
    mapa_modal_titulo: "Mapa",
    mapa_btn_abrir: "Abrir en Nueva Pestaña",
    mapa_btn_baixar: "Descargar",
    mapa_abrir_nova_aba: "Abrir imagen en nueva pestaña",
    mapa_baixar_imagem: "Descargar imagen",
    btn_voltar_topo: "Volver arriba",
    btn_fechar: "Cerrar",
    footer_sobre_titulo: "Sobre FAPESPA",
    footer_sobre_texto: "Fundación Amazonia de Apoyo a Estudios e Investigaciones, promoviendo ciencia, tecnología e innovación para el desarrollo del estado.",
    footer_produtos_titulo: "Productos",
    footer_localizacao_titulo: "Ubicación",
    footer_iframe_title: "Ubicación FAPESPA",
    footer_copyright: "© Anuario Estadístico de Pará. Todos los derechos reservados.",
    modal_conteudo: "Contenido",
    modal_abrir_nova_aba: "Abrir en nueva pestaña",
    // MAPA AVANZADO
    mapa_buscar_placeholder: "Buscar municipio...",
    mapa_limpar_busca: "Limpiar búsqueda",
    mapa_3d_toggle: "Vista 3D",
    mapa_exportar_dados: "Exportar Datos",
    mapa_tela_cheia: "Pantalla Completa",
    mapa_filtros_avancados: "Filtros Avanzados",
    mapa_valor_faixa: "Rango de Valores:",
    mapa_valor_minimo: "Valor Mínimo",
    mapa_valor_maximo: "Valor Máximo",
    mapa_regiao: "Región de Integración",
    mapa_selecione_regiao: "Seleccione una región",
    mapa_aplicar_filtros: "Aplicar Filtros",
    mapa_limpar_filtros: "Limpiar Filtros",
    mapa_tab_info: "Información",
    mapa_tab_comparar: "Comparar",
    mapa_tab_historico: "Histórico",
    mapa_tab_estatisticas: "Estadísticas",
    mapa_municipio_nome: "Municipio",
    mapa_municipio_regiao: "Región",
    mapa_municipio_valor: "Valor",
    mapa_comparacao_vazia: "Ningún municipio seleccionado",
    mapa_comparacao_instrucao: "Haga clic en un municipio en el mapa para agregar a la comparación (máximo 5).",
    mapa_historico_vazio: "Seleccione un municipio",
    mapa_estatisticas_media: "Promedio Estatal",
    mapa_estatisticas_maior: "Valor Máximo",
    mapa_estatisticas_menor: "Valor Mínimo",
    mapa_estatisticas_desvio: "Desviación Estándar",
...
function changeLanguage(lang) {
  try {
    ...
    // Suporte para aria-labels (acessibilidade)
